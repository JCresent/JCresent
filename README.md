...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Tiny5&size=24&duration=6000&pause=2000&color=FF4500&random=false&width=600&height=40&lines=Welcome+to+my+page%2C+my+name+is+Justin+Cresent)](https://git.io/typing-svg)
> Interested in new projects (fullstack, game dev, security, and ML)
---
## Education
#### Major in CS & Minor in DS @ William & Mary
> **Notable Coursework:** Software Engineering, Software Development, Operating Systems, Systems Programming, Mobile Application Security, Network Systems and Design, Web Programming, Applied Machine Learning, Finite Automata, Cloud Computing, Edge Computing 
